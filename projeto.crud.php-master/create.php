...
<?php
$sexo = isset($sexo) ? $sexo : false; ?> 

<!-- // Mesmo que a variável original não exista criamos ela falsa mesmo assim ela sempre vai existir

//<input type="radio" name="sexo" id="sexo" value="M" <?= ($sexo=="M"  ? "checked" : null) ?> /> Masculino -->
<!-- //https://forum.imasters.com.br/topic/584766-variavel-indefinida-sexo/ -->
...
//    if(preg_replace('/[óòõôö]/ui', 'o', $nome);
//     $nomeErro = 'formato errado do nome';
//     $validacao = false;
// }
...
$nome = sanitizeString($nome);
     ...
     {
        if(!preg_match('^\(+[0-9]{3}\) [0-9]{3}-[0-9]{4}$^', $telefone)){
            echo "Telefone inváildo.";
            $telefoneErro = 'formato errado';
            $validacao = false;
        }
    }

// isValid("(123) 456-7890") ➞ true   $telefone = "(82) 5555-5555";
    ...
    if(empty($sexo))
    {
        ...
        {
            echo 'erro insercao!!! ?? email ex @asddsa.com??? ';
        }
    }
?>
